	...
	return (
		<div className='bg bg-gray-100'>
			...
			<div className='font-light text-lg text-gray-500'>
				<h3 className='text-xl text-center pb-2 font-semibold'>
					Introducing the Pioneer:
				</h3>
				<p className='leading-7 text-center px-6'>{DESCRIPTION}</p>
			</div>
